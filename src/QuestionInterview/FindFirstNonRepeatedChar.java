...
/**
 * Created by m.karandish on 2/5/2019.
 */
 ...
 * * repeated character from String. */
    ...
    * * non repeated character. Here order is achieved by going *
    ...
    public static void main(String[] args) {
        System.out.println(firstNonRepeatedCharacter("Programmer"));
        System.out.println(firstNonRepeatingChar("believed"));
        System.out.println(getFirstNonRepeatedChar("test"));
    }
